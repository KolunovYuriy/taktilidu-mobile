...
import { DriverFeedbackForm } from '../../../components/Forms'
import { MainButton as Button } from '../../../components/Button'

import styles from './styles'

class DriverFeedbackScreen extends Component {
      ...
      <Container>
        ...
        <Content padding={10}>
          ...
          <View style={styles.feedbackDetailsSection}>
            <Text style={styles.feedbackDetails}>Как вы оцените поездку?</Text>
          </View>
          <DriverFeedbackForm />
